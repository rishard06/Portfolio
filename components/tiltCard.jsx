...
export default function TiltCard({ title, description, image, buttonText, className }) {
  return (
    <CardContainer className={cn("inter-var", className)}>
      <CardBody className="backdrop-blur-3xl bg-gray-50/30 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black/30 dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        <CardItem
          translateZ="50"
